...
<link rel="icon" type="image/png" href="/favicon-new.png">
    ...
    <title>رزومه فاطمه  محبی </title>
<meta name="description" content="علاقه مند به پیشرفت در حیطه برنامه نویسی ">
...
<link href="/css/DefaultResume-RTL.css?v=H853kMGuHwWynZfvuWAKC7GSc7BfbODoPJOHmMm5Vow" rel="stylesheet">
...
<script>
    ...
    <div class="container">
        ...
        <div class="line3"></div>
        <div class="line4"></div>
        <div class="row" style="height:100%" id="main-content">
            <div class="smbox col-narrow sortable-cv-items">
                <div class="user-image not-drag" style="background-image:url(/images/female.jpg);"></div>
                <h1 class="not-drag">فاطمه  محبی</h1>
                    <h4 class="not-drag">
                        برنمه نویس 
                    </h4>
    ...
    <div class="property-item basic__about" data-section="About">
        ...
        <div class="property-item_body">
            <p class="about-us">
                علاقه مند به پیشرفت در حیطه برنامه نویسی 
            </p>
        </div>
    </div>
...
<div class="infoo info" data-section="Contact">
    ...
    <div class="contact-item contact__mobile">
                ...
                <span>موبایل:</span>
                <span style="unicode-bidi:embed" dir="ltr">(&#x2B;۹۸)۹۱۵۰۴۶۶۳۳۱</span>
    </div>
            <div class="contact-item contact__phone">
                ...
                <span>آدرس:</span>
                <span>خراسان رضوی، فریمان، شهرک قائم-قائم2-پ 23</span>
            </div>
</div>
        ...
        <div class="property-item_body">
            <div class="bar-progress item-row w0">
                <ul class="history">
                        ...
                        <li>
                            <span>
                                <label>  javascript، bootstarp</label>
                                    <label class="grade">
                                        <small>20%</small>
                                            <i class=tik></i>
                                            <i ></i>
                    ...
                    <ul class="history">
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">زبان  vb.net</div>
                                </div>
                            </li>
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">نرم flex book</div>
                                </div>
                            </li>
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">  javascript، bootstarp</div>
                                </div>
                            </li>
                            <li>
                                <div class="c100 p20 small">
                            ...
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">  c# programming language</div>
                                </div>
                            </li>
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">kotlin</div>
                                </div>
                            </li>
                            <li>
                                <div class="c100 p20 small">
                                    ...
                                    <div class="circle-progress__title">  android studio</div>
                                </div>
                            </li>
                    </ul>
                </div>
                        ...
                        <li>
                            <span>
                                <label>
                                    ...
                                    <label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://t.me/godonly_7" target="_blank">godonly_7</a></label>
                        ...
                        <li>
                            <span>
                                <label>
                                    ...
                                    <label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://instagram.com/godonly_7" target="_blank">godonly_7</a></label>
    ...
    <div class="property-item education__list" data-section="Education">
        ...
        <div class="property-item_body">
            <ul class="history multi-line">
                    <li>
                        <h2 class="subtitle">کارشناسی ارشد  مهندسی کامپیوتر</h2>
                        <h3 class="subtitle">گرایش: نرم افزار</h3>
                                    <h3 class="subtitle">موسسه/دانشگاه: - <label>پیام نور</label></h3>
                                                    <label class="date">ورودی سال  ۱۴۰۰</label>
                                                    <label class="Education-Grade">معدل : -</label>
                    </li>
            </ul>
        </div>
    </div>
...
<script>
    ...
    <style>
        ...
        <script src="/js/template-release.js?v=C7TP8DNqWtpMtX4XZSpgTl0vDBXNBkXEgJw1HiAJyxo"></script>
    <script>
